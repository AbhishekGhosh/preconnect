...
Adds preconnect crossorigin link relation type to indicate an origin that will be used to fetch required resources as described in W3C Working Draft. Intended for HSTS websites.
